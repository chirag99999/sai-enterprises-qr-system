      ...
      <GlassCard elevated className="w-full p-4 sm:p-7 flex flex-col items-center relative overflow-hidden">
        ...
        {step === "WHATSAPP_VERIFY" && (
          <div className="w-full flex flex-col items-center text-center z-10">
            <div className="w-14 h-14 rounded-2xl bg-emerald-600 text-white flex items-center justify-center mb-3 shadow-lg shadow-emerald-600/30 animate-float-gentle">
            ...
            {/* Big Code Pill with Living Aura */}
            <div className="my-4 p-4 rounded-2xl bg-emerald-50 border-2 border-emerald-300 w-full max-w-xs shadow-xs animate-subtle-pulse">
            ...
            <div className="w-full max-w-xs space-y-2.5">
              <button
                ...
                className="w-full py-3.5 px-4 rounded-2xl bg-emerald-600 hover:bg-emerald-700 active:scale-[0.98] text-white font-black text-sm tracking-wide shadow-md flex items-center justify-center gap-2 transition shine-effect"
              >
